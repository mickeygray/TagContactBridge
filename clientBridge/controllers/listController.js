const logicsService = require("../../shared/services/logicsService");
const {
...
const PeriodContacts = require("../../shared/models/PeriodContacts");
...
const {
  validatePhone,
  validateEmail,
} = require("../../shared/services/validationService");
const ValidatedPhone = require("../../shared/models/ValidatedPhone");
