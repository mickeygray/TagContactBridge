...
// phoneBurnerService is bridge-specific — lazy-load to avoid hard dependency
let _removePbContact;
...
async function deactivateLead({
  ...
  try {
    ...
    for (const lead of leads) {
      if (lead.pbContactId) {
        const pbResult = await getRemovePbContact()(lead.pbContactId);
